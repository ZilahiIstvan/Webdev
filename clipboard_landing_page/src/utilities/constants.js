...
// pngs
export const headerBg = require("../imgs/bg-header-desktop.png");
export const computerImg = require("../imgs/image-computer.png");
export const devicesImg = require("../imgs/image-devices.png");
export const googleImg = require("../imgs/logo-google.png");
export const ibmImg = require("../imgs/logo-ibm.png");
export const microsoftImg = require("../imgs/logo-microsoft.png");
export const hpImg = require("../imgs/logo-hp.png");
export const vectorImg = require("../imgs/logo-vector-graphics.png");

// svgs
export const logoSvg = (svgParams) => {
  const { svgClasses } = svgParams;
  return (
    <svg
...
export const blacklistSvg = (svgParams) => {
  const { svgClasses } = svgParams;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      ...
      className={svgClasses}
    >
      <g fill="#9EABB2" fillRule="nonzero">
...
export const sneakSvg = (svgParams) => {
  const { svgClasses } = svgParams;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
...
export const textSvg = (svgParams) => {
  const { svgClasses } = svgParams;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
...
export const facebookSvg = (svgParams) => {
  const { svgClasses } = svgParams;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
...
export const twitterSvg = (svgParams) => {
  const { svgClasses } = svgParams;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
...
export const instagramSvg = (svgParams) => {
  const { svgClasses } = svgParams;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
