...
export const mockupsImg = require("../imgs/image-mockups.png");

export const logo = (params) => {
  const { logoClass } = params;
  return (
    <svg
...
export const bgIntroDesktop = (params) => {
  const { bgIntroDesktopClass } = params;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      xmlnsXlink="http://www.w3.org/1999/xlink"
      viewBox="0 0 1271 1034"
      className={bgIntroDesktopClass}
    >
      <defs>
